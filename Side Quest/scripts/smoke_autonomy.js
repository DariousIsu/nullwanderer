...
(async () => {
  ...
  mem.exec(`CREATE TABLE inquiries (id INTEGER PRIMARY KEY, question TEXT, born_from TEXT, status TEXT DEFAULT 'active', evidence TEXT, gist TEXT, open_leads TEXT, next_step TEXT, touches INTEGER DEFAULT 0, expect_trail TEXT, created_ts INTEGER, last_touched_ts INTEGER, closed_ts INTEGER, answer TEXT, contract_id TEXT, slot_id TEXT, assumption TEXT);
