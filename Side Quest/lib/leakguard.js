...
const _INTERNAL_TAG_RE = /^<\/?(?:think|thinking|thought|thoughts|say|navigate|wonder|web[\w-]*|echo[\w-]*|browser[\w-]*|browse[\w-]*|files?[\w-]*|screen[\w-]*|inbox[\w-]*|sched[\w-]*|scheduler[\w-]*|presence[\w-]*|email[\w-]*|discord[\w-]*|recall[\w-]*|image-gen|draw|imagine|dig|open-?thread[\w-]*|status[\w-]*|tool[\w-]*|act[\w-]*|wait|read-[\w-]*|observe-[\w-]*|clipboard[\w-]*|notify|chat-[\w-]*|remember[\w-]*|forget[\w-]*)\b/i;
