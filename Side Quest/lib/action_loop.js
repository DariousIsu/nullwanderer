  ...
  return {
    ...
    steps: [
      ...
      },
      {
        ...
        expect: 'email-body',
        directive: () => `You are writing a reply email to ${to}. Their message was: "${(snippet || '').slice(0, 220)}".\n\nWrite it in YOUR OWN voice — you are Zoe Lane, a real correspondent, not a corporate auto-responder. Direct, warm, specific to what they actually said. NO boilerplate: no "I hope this email finds you well", no "as per your request", no "I am an AI", no canned "Please don't hesitate to reach out" sign-offs. Say the real thing, the way you'd actually say it.\n\nSay only what is true. This reply carries no attachment, so don't claim to have attached, included, or enclosed anything, and don't describe an action you haven't taken. If a point needs a document you don't have, offer to follow up rather than pretending it's already attached.\n\nEmit your reply inside ONE tag, exactly like this:\n<email-body>your reply text here</email-body>\nOnly that single tag with your message inside it. No To: or Subject: lines — just the body.`,
        check: (ctx) => {
