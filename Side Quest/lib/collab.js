...
function directive() {
  return '[COLLABORATION REGISTER: this turn is THINKING TOGETHER, not a work order. Your ideas, reactions, and connections go IN THIS REPLY — concrete, specific, grounded in the held material below (cite it by name), and positioned so they can bounce them back. Give real substance: angles, framings, connections between their documents, disagreements. Do NOT create or edit any artifact, do NOT say "let me get that going" or "it\'s on your canvas", do NOT convert this into a deliverable or book work — unless they explicitly named a destination this turn. Conversation IS the deliverable.]';
}
