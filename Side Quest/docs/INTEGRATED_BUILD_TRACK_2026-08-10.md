...
- ▶ **NEXT: C3 — grounded reflection** (built to the §1 Honest-Lying constraint: synthesize over recent high-importance material INCLUDING landed documents, ground each belief in cited episodes, programmatic inputs, RRR monitor). This is what fully pays off C2's document pressure. Then C4 persona-anchored drive.
