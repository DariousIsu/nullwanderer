...
- ▶ **NEXT: R2** (serve-vs-rebuild trust gate — verify what `product_ledger`/`presentHeldProduct` already covers; likely small) → ★ commissioned LA run (live). Then Phase C (Spine 4).
