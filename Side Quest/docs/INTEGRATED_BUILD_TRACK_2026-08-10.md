...
- ▶ **NEXT: ★ commissioned LA run** — the beta acceptance test (live, quota-gated): a real "swarm the LA roster" (R4) → complete, governance-scoped, source-verified, coverage-honest, openable sheet, every blank a verified "not published." **Phase A is otherwise CODE-COMPLETE.** Then Phase C (Spine 4).
