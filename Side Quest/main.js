...
// ⭐ A CONCRETE EXAMPLE, NOT PLACEHOLDERS. Live 2026-07-21 she copied "KEY" and "TITLE" straight
// out of this entry — the canvas tab was literally titled "TITLE" — and then alternated between
// `content` and `data` and dropped `block_type`, burning four hops on validation errors. An example
// written in placeholders invites substitution errors; one written in real values shows the SHAPE
